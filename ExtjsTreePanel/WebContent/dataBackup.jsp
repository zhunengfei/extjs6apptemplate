...
d = "[{'id':'"+leaf+10+"','text':'Child of "+(leaf+10)+"','children':[{'id':'"+leaf+20+"','text':' Child of "+(leaf+20)+"'}]},{'id':'"+(leaf+30)+"','text':'Child of "+(leaf+30)+"','children':[{'id':'"+(leaf+40)+"','text':'"+(leaf+40)+"','leaf':true}]}]";
